...
const Pricing = () => {
  ...
  return (
    <div className="flex flex-col items-center mb-10">
      <h1 className="lg:text-4xl text-2xl uppercase font-bold pt-10 md:pt-3 text-sky-950 text-center">Pricing Plans</h1>
      <p className="text-gray-500 mb-4">Choose the plan that fits your needs.</p>
      <button
      ...
      <div className="flex flex-col md:flex-row justify-center">
        <div className="bg-yellow-200 rounded-lg shadow-lg p-6 w-64 m-4">
          ...
          <button className="bg-yellow-500 text-white py-2 px-4 rounded mt-2">Select</button>
        </div>
        <div className="bg-blue-400 rounded-lg shadow-lg p-6 w-64 m-4">
          ...
          <p className="text-gray-700">{isYearly ? '$100/year' : '$10/month'}</p>
          <button className="bg-blue-500 text-white py-2 px-4 rounded mt-2">Select</button>
        </div>
        <div className="bg-green-400 rounded-lg shadow-lg p-6 w-64 m-4">
          ...
          <p className="text-gray-700">{isYearly ? '$200/year' : '$20/month'}</p>
          <button className="bg-green-500 text-white py-2 px-4 rounded mt-2">Select</button>
        </div>
      </div>
    </div>
  );
