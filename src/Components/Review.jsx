            ...
            >
                <SwiperSlide>
                    <div className=" flex flex-col items-center md:mx-40">
                        ...
                        <h3 className="md:text-2xl text-green-600 font-bold uppercase">Mark</h3>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    <div className=" flex flex-col items-center md:mx-40">
                        ...
                        <h3 className="md:text-2xl text-green-600 font-bold uppercase">Titan</h3>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    <div className=" flex flex-col items-center md:mx-40">
                        ...
                        <h3 className="md:text-2xl text-green-600 font-bold uppercase">Tonmoy</h3>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    <div className=" flex flex-col items-center md:mx-40">
                        ...
                        <h3 className="md:text-2xl text-green-600 font-bold uppercase">Hassan</h3>
                    </div>
                </SwiperSlide>
            </Swiper>
        </div>
