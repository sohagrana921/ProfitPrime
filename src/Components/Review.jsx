  ...
  return (
    <div id="testimonials">
      <div className="text-center my-16 md:my-32  md:mx-64">
        ...
        <h3 className="md:text-2xl font-bold border-purple-900 border-y-4 py-2 uppercase text-red-800">WHAT OUR CLIENTS SAY</h3>
      </div>
        ...
        >
          <SwiperSlide>
            <div className=" flex flex-col items-center md:mx-40">
              ...
              <p className="my-4">
                ...
                business revenue. The features provided by ProfitPrime have helped
                streamline my processes and improve my overall business
          ...
          <SwiperSlide>
            <div className=" flex flex-col items-center md:mx-40">
              ...
              <p className="my-4">
                I have found ProfitPrime to be an effective platform for boosting
                revenue. Its range of tools and resources have given my business a
                competitive edge. The insights provided by ProfitPrimes analytics
                have been invaluable in understanding customer behavior and
          ...
          <SwiperSlide>
            <div className=" flex flex-col items-center md:mx-40">
              ...
              <p className="my-4">
                ...
                revenue optimization solutions. The platforms innovative approach
                has helped me monetize my artistic endeavors more effectively.
                With ProfitPrimes guidance, I have been able to reach a wider
