    ...
    <div className="navbar  bg-green-900 text-white font-bold fixed z-10 top-0 max-w-screen-xl mx-auto">
      <div className="navbar-start">
        <div className="dropdown">
          ...
          <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-green-900 text-white hover:text-white rounded-box w-52">
            <Link to={'/'}><li><a className="hover:text-white hover:bg-green-700">Home</a></li></Link>
            <li tabIndex={0}>
              <details>
      ...
      <div className="navbar-end">
        <Link to={'/login'}><button className="hover:bg-green-700 p-3 rounded-md">Login</button></Link>
      </div>
    </div>
  );
};
