    ...
    <footer className="bg-[#123426] text-white text-center mt-12 rounded-t-sm lg:text-left">
      <div className="mx-6 py-10 text-center lg:text-left">
        <div className="grid-1 grid gap-10 lg:grid-cols-3">
          <div>
            <h6 className=" mb-4 flex items-center justify-center font-bold text-2xl lg:justify-start">
              <img className="w-12 h-12 rounded-full mr-3" src="" alt="" />
              ProfitPrime
            </h6>
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Minus
              aspernatur itaque, nostrum dignissimos aliquid delectus aperiam
              porro. Provident, officiis id?
            </p>
          </div>
