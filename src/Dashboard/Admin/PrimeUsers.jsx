              ...
              {primeUsers.map((user) => (
                <tr key={user._id}>
                  ...
                  <td>
                    ...
                    >
                      <button
                        className="btn btn-xs bg-gradient-to-r from-green-700 to-green-900 text-white border-none"
                    ...
                    <dialog id="my_modal_3" className="modal">
                      <form method="dialog" className="modal-box">
                        ...
                        <input
                          ...
                          className="btn bg-gradient-to-r from-green-700 to-green-900 text-white mt-3 text-center"
                          value="Send"
                        />
                      </form>
                    </dialog>
