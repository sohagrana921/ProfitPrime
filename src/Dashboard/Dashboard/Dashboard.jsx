            ...
            <div className="drawer lg:drawer-open">
                ...
                <div className="drawer-side">
                    ...
                    <ul className="menu p-4 w-80 h-full bg-gradient-to-r from-green-600 to-green-900 text-white text-xl">
                        ...
                        <li><NavLink to={'/dashboard/cs'} className="hover:text-white hover:bg-green-700"><AiFillCaretRight/> Consulting Service</NavLink></li>
                        <li><NavLink to={'/dashboard/comps'} className="hover:text-white hover:bg-green-700"><FaBattleNet/> Competitor solution</NavLink></li>
                        <li><NavLink to={'/dashboard/dai'} className="hover:text-white hover:bg-green-700"><FcDatabase/> Data Analysis $ Insight</NavLink></li>
                        <li><NavLink to={'/dashboard/help'} className="hover:text-white hover:bg-green-700"><FaHandsHelping/> Help</NavLink></li>
